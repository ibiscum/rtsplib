...
bool SocketUtil::bind(SOCKET sockfd, const std::string &ip, uint16_t port) {
...
bool SocketUtil::connect(SOCKET sockfd, const std::string &ip, uint16_t port, int timeout) {
